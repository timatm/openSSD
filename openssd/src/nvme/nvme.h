...
/* customized admin commands (>= 0xD0) for monitoring nmc utilities */
...
/* customized nvm commands (>= 0xC0) for nmc applications */
...
#define SC_INVALID_QUEUE_IDENTIFIER                                                                               \
    0x01 // Create I/O Submission Queue, Create I/O Completion Queue, Delete I/O Completion Queue, Delete I/O
         // Submission Queue
...
/* Status Code - NMC Specific */
#define SC_VENDOR_NMC_SUCCESS                      0x00
#define SC_VENDOR_NMC_MAPPING_DISABLED             0x01
#define SC_VENDOR_NMC_MAPPING_REOPENED             0x02
#define SC_VENDOR_NMC_MAPPING_RECLOSED             0x03
#define SC_VENDOR_NMC_MAPPING_FILENAME_TOO_LONG    0x04
#define SC_VENDOR_NMC_MAPPING_FILENAME_UNSUPPORTED 0x05
#define SC_VENDOR_NMC_MAPPING_REGISTER_INIT_FAILED 0x06
#define SC_VENDOR_NMC_MAPPING_REGISTER_DONE_FAILED 0x07
...
typedef struct _NVME_IO_COMMAND
{
    union
    {
        ...
        struct
        {
            ...
            /**
             * @todo For read and write commands, CDW[10, 11] were used for:
             *
...
/**
 * @brief The main structure of completion queue entry.
 *
 * A completion queue entry consisted of 4 DWORDs (16B)
 *
 * @warning but here only 2DW?
 */
typedef struct _NVME_COMPLETION
{
    union
    {
        ...
        struct
        {
            union // NVME Base Spec 2.0b 3.3.3.2.1
            {
                ...
                struct
                {
                    ...
                    unsigned short MORE : 1; // More Err Info
